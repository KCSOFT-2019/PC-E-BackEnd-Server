...
public class EvaluationDaoTest {
	...
	public void selectManyByUsernameTest() {
		System.out.println(Arrays.toString(dao.selectManyByUsername("wangzisfa").toArray()));
	}

	@Test
	public void selectManyBySolverNameTest() {
		System.out.println(Arrays.toString(dao.selectManyBySolverName("wuzong").toArray()));
	}
}
